...
public class SecurityConfigurations {
    ...
    public JwtEncoder jwtEncoder() {
        return new NimbusJwtEncoder(
                new ImmutableJWKSet<>(new JWKSet(new RSAKey.Builder(new PublicKeyConverter().convert(publicKey.trim())).privateKey(new PrivateKeyConverter().convert(privateKey)).build())));
    }
